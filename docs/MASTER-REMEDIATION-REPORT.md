...
_(Strictly not GO or 100% — Prompt 40 Adversarial Pentest & Prompt 41 Reality Check must be re-run from scratch)._
...
1. **P1.1 Open Redirect in OAuth Callback:**  
   _File:_ [`app/auth/callback/route.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/app/auth/callback/route.ts#L36-L43)  
...
2. **P1.2 Production Error Information Leak:**  
   _File:_ [`shared/middleware/rbacGuard.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/shared/middleware/rbacGuard.ts#L241-L249)  
...
3. **P1.3 HTML Injection in Transactional Emails:**  
   _File:_ [`infrastructure/email/resendClient.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/infrastructure/email/resendClient.ts#L55-L100)  
...
4. **P1.4 Unrestricted Outbound Email Dispatch:**  
   _File:_ [`domains/notifications/api/notificationController.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/domains/notifications/api/notificationController.ts#L18-L30)  
...
5. **P1.5 Missing HTTP Security Headers:**  
   _File:_ [`next.config.mjs`](file:///c:/Users/Acer/Music/TASQ-ONE/next.config.mjs#L26-L41)  
...
6. **P1.6 In-Memory-Only Rate Limiter:**  
   _File:_ [`infrastructure/redis/redisClient.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/infrastructure/redis/redisClient.ts#L171-L215)  
...
7. **P1.7 Postgres REPLICA IDENTITY FULL for Realtime DELETE Events:**  
   _File:_ [`supabase/migrations/0010_tasks_replica_identity_full.sql`](file:///c:/Users/Acer/Music/TASQ-ONE/supabase/migrations/0010_tasks_replica_identity_full.sql)  
...
9. **P1.9 Duplicate Migration Prefix:**  
   _Action:_ Renamed `supabase/migrations/0003_team_assignment_guarantee.sql` to `supabase/migrations/0004_team_assignment_guarantee.sql` via git.
10. **P1.10 Dependency Vulnerability Remediation:**  
    _File:_ [`package.json`](file:///c:/Users/Acer/Music/TASQ-ONE/package.json)  
...
11. **P1.11 Team Reassignment Authorization Bypass:**  
    _File:_ [`domains/users/api/userController.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/domains/users/api/userController.ts#L58-L75)  
...
1. **P2.1 Environment Variable Documentation & Zod Boot-Time Guard:**  
   _Files:_ [`.env.local.example`](file:///c:/Users/Acer/Music/TASQ-ONE/.env.local.example), [`lib/env.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/lib/env.ts#L4-L65)  
...
2. **P2.2 Form Label `htmlFor`/`id` Pairing & A11y Polish:**  
   _Files:_ [`app/(auth)/login/page.tsx`](<file:///c:/Users/Acer/Music/TASQ-ONE/app/(auth)/login/page.tsx>), [`app/(auth)/signup/page.tsx`](<file:///c:/Users/Acer/Music/TASQ-ONE/app/(auth)/signup/page.tsx>)  
...
3. **P2.3 Computed Velocity Average:**  
   _Files:_ [`domains/tasks/usecases/getManagerDashboard.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/domains/tasks/usecases/getManagerDashboard.ts#L108-L120), [`domains/tasks/usecases/getAdminDashboard.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/domains/tasks/usecases/getAdminDashboard.ts#L90-L102)  
...
4. **P2.4 Dead Asset Removal & README Path Alignment:**  
   _Files:_ `public/Trans logo.png` (deleted), [`README.md`](file:///c:/Users/Acer/Music/TASQ-ONE/README.md#L430-L442)  
...
5. **P2.5 Explicit CORS Configuration:**  
   _File:_ [`next.config.mjs`](file:///c:/Users/Acer/Music/TASQ-ONE/next.config.mjs#L18-L25)  
...
1. **Real PostgreSQL CI Service Container:**  
   _File:_ [`.github/workflows/pr-check.yml`](file:///c:/Users/Acer/Music/TASQ-ONE/.github/workflows/pr-check.yml#L16-L55)  
...
2. **Elimination of Mock Array Testing in RLS Suite:**  
   _File:_ [`tests/rls/multi_tenant_isolation.test.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/tests/rls/multi_tenant_isolation.test.ts)  
...
3. **P0.4 IDOR Regression Test Suite:**  
   _File:_ [`tests/rls/multi_tenant_isolation.test.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/tests/rls/multi_tenant_isolation.test.ts#L140-L245)  
...
4. **P0.2 Privilege Escalation Fail-Closed Regression Suite:**  
   _File:_ [`tests/rls/cross_role_routing.test.ts`](file:///c:/Users/Acer/Music/TASQ-ONE/tests/rls/cross_role_routing.test.ts#L239-L345)  
